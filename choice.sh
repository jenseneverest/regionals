...
opkg --force-overwrite --force-downgrade --force-reinstall install https://github.com/jenseneverest/regionals/raw/master/crossepg-virgin-alias-mod_5.0.3_all.ipk
echo ""
echo ""
echo ""
echo ""
